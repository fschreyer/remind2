...
reportPrices <- function(gdx, output=NULL, regionSubsetList=NULL,
  ...
  # load DAC emi marginal and add entries before 2025 as 0
  q33_DAC_emi <- new.magpie(getRegions(q_balcapture), getYears(q_balcapture), fill = 0)
